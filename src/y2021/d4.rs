                            ...
                            let sum = board
                                ...
                                .map(|(i, inner_row)| {
                                    inner_row
                                        .iter()
                                        .enumerate()
                                        .filter(|(j, _inner_col)| !board.marked[i][*j])
                                        .map(|u| u.1)
                                        .sum::<u32>()
                                })
                                .sum::<u32>();
...
pub fn part2(input: String) -> String {
    ...
    for call in calls {
        ...
        'board_loop: while let Some(_) = board.checked_sub(1) {
            // breaks on checked sub that underflows
            board -= 1;
                                ...
                                let sum = boards[board]
                                    ...
                                    .map(|(i, inner_row)| {
                                        inner_row
                                            .iter()
                                            .enumerate()
                                            .filter(|(j, _inner_col)| !boards[board].marked[i][*j])
                                            .map(|u| u.1)
                                            .sum::<u32>()
                                    })
                                    .sum::<u32>();
